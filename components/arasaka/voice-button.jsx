  ...
  return (
    <>
      <Button
        ...
        className={cn(
          'relative gap-2 border border-border bg-card font-mono text-[11px] font-medium uppercase tracking-[0.18em] text-foreground transition-colors hover:bg-muted',
      ...
      <AnimatePresence>
        {(feedback || (listening && transcript)) && (
          ...
          >
            <div
              className="flex items-center gap-2 border border-border bg-card px-4 py-2 font-mono text-[11px] font-medium uppercase tracking-[0.2em] shadow-sm"
              style={{ borderRadius: 'var(--radius)' }}
            >
