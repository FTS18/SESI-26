...
export const BLOCKS = [
  { id: 'A', name: 'Block A', kind: 'Academic', area: 12400, capacity: 320, status: 'optimal', floors: 4, roomsPerFloor: 8 },
  { id: 'B', name: 'Block B', kind: 'Academic', area: 9800, capacity: 280, status: 'optimal', floors: 4, roomsPerFloor: 7 },
  { id: 'C', name: 'Block C', kind: 'Lab', area: 6200, capacity: 180, status: 'attention', floors: 3, roomsPerFloor: 6 },
  { id: 'L', name: 'Library', kind: 'Common', area: 4800, capacity: 140, status: 'optimal', floors: 3, roomsPerFloor: 4 },
  { id: 'CAF', name: 'Cafeteria', kind: 'Common', area: 2400, capacity: 90, status: 'critical', floors: 2, roomsPerFloor: 4 },
  { id: 'HN', name: 'Hostel North', kind: 'Residence', area: 14600, capacity: 420, status: 'optimal', floors: 5, roomsPerFloor: 10 },
  { id: 'HS', name: 'Hostel South', kind: 'Residence', area: 13800, capacity: 410, status: 'attention', floors: 5, roomsPerFloor: 10 },
  { id: 'SP', name: 'Sports Complex', kind: 'Facility', area: 8200, capacity: 220, status: 'optimal', floors: 2, roomsPerFloor: 6 },
]
